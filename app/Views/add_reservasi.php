...
<head>
    ...
    <link rel="stylesheet" type="text/css"
	    media="all" href="/assets/styles/style_form.css">
</head>
<body>
    <h1>FORM TAMBAH DATA RESERVASI COFFEE PASTE</h1>
    <div class="container">
        <form action=<?= base_url("/reservasi/save") ?> method="POST">
        <table class="left">
            <tr>
            ...
            <tr>
                ...
                <td>: <input type="text" name="nama" id="nama" placeholder="Masukkan Nama Pemesan"></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>: <input type="text" name="telp" id="telp" placeholder="Masukkan Nomor Telepon"></td>
            </tr>
            <tr>
        ...
        <aside>
            <table>
                ...
                <tr>
                    ...
                    <td>: <input type="number" name="jml_org" id="jml_org" placeholder="Masukkan Jumlah Orang"></td>
                </tr>
                <tr>
